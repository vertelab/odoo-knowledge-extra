...
class WebsiteDocument(http.Controller):
    ...
    def get_attachment(self, attachment=None, file_name=None, **post):
        if attachment and attachment.datas:
            return http.send_file(StringIO(attachment.datas.decode('base64')), filename=attachment.datas_fname, mimetype=attachment.mimetype, mtime=attachment.write_date)
